...
def get_datasets(initial_pool):
    ...
    # load the data
    train_ds = DataClass(split='train', transform=transform, download=download)
    aug_train_ds = DataClass(split='train', transform=aug_transform, download=download)
    test_set = DataClass(split='test', transform=test_transform, download=download)
    ...
    return eald_set, test_set, n_classes
...
def main():
    ...
    with open("results/csv/metrics_cifarnet_" + dt_string + "_" + tag + "_.csv", "w+", newline="") as out_file:
        ...
        active_set, test_set, n_classes = get_datasets(hyperparams["initial_pool"])
