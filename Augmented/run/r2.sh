...
python "${SCRIPT}.py" --epoch 50 --initial_pool 100 --learning_epoch 5 --heuristic $HEURISTIC --tag "r2_${SLURM_JOB_NAME}"

remove_new_environment $SLURM_JOB_NAME

cd /home/keki996e/AL4ML/ACTIVE/OwnExperiments/Rep-Baal-Progress/Augmented/run

sbatch -J "r3_${SLURM_JOB_NAME}" r3.sh $SCRIPT $HEURISTIC 
